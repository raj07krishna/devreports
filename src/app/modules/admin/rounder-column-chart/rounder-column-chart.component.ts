...
import { ChartComponent, IPointRenderEventArgs, ILoadedEventArgs, ChartTheme } from '@syncfusion/ej2-angular-charts';
import { Browser } from '@syncfusion/ej2-base';

@Component({
  selector: 'app-rounder-column-chart',
  templateUrl: './rounder-column-chart.component.html',
  styleUrls: ['./rounder-column-chart.component.scss']
})
export class RounderColumnChartComponent {
  @Input() id
  @ViewChild('roundcol')
